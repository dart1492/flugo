...
const _josefinFontName = 'Josefin';

CTextStyle get josefin => const Josefin();

class Josefin extends CTextStyle {
  const Josefin()
      : super._(
...
class CTextStyle extends TextStyle {
  ...
  // colors
  CTextStyle withColor(Color color) => copyWith(color: color);
